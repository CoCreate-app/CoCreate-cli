...
module.exports.push = async function(repository,prompt){
        try{
          console.log("************* -> ",repository.path)
            ...
            .push(['-u', 'origin', prompt.branch,'--set-upstream'], () => {
...
module.exports.cloneRepository = async function(repository,prompt){
...
/*        console.log(" Git. URL to replace ",gitHubUrl)
        console.log(" gitHubUrl_repo  ",gitHubUrl_repo)*/
      
        await simpleGit.clone(gitHubUrl_repo,()=>{
             ...
             // console.log("Process ",process.cwd())
              console.log("Clone Sucessfuly ",folder_repo)
